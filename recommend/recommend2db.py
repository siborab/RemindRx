...
def recommend2db(text: str):
    ...
    supabase.table("prescriptions").insert({"patient": 6,"description": text, "recommended_times": predicted_times}).execute() #insert the new prescription into the database
